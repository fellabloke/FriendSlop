...
{
    [InitializeOnLoad]
    public static class HouidiPromo_PhysicsPickup
    {
        private const string ASSET_NAME = "Physics Pickup";
        private const string PREFS_KEY  = "Houidisoft_Promo_DontShow_PhysicsPickup";
        ...
        static HouidiPromo_PhysicsPickup()
        {
        ...
        private static void TryShow()
        {
            if (!EditorPrefs.GetBool(PREFS_KEY, false))
                HouidiPromoWindow_PhysicsPickup.Open(ASSET_NAME, PREFS_KEY, PLANAR_URL, WATER_URL, PUBLISHER_URL);
        }
    ...
    public class HouidiPromoWindow_PhysicsPickup : EditorWindow
    {
        ...
        {
            var win = GetWindow<HouidiPromoWindow_PhysicsPickup>(true, "Houidisoft Technology", true);
